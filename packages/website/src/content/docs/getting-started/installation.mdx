...
<Tabs>
  <TabItem label="npm">```bash npm install -D chronus ```</TabItem>
  <TabItem label="pnpm">```bash pnpm add -D chronus ```</TabItem>
  <TabItem label="yarn">```bash yarn add -D chronus ```</TabItem>
  <TabItem label="npx (no install)">```bash npx chronus ```</TabItem>
</Tabs>
